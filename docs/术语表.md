...
> 本文档定义了 GPF 项目中使用的标准术语，确保所有文档和代码的一致性。
...
| 类型 | 命名规则 | 示例 | 说明 |
|------|----------|------|------|
| **文档文件** | *.md | README.md | 新版本文档 |
| **组件文件** | *.sh | context.sh | 功能组件 |
| **命令文件** | *.sh | start.sh | 命令实现 |
...
- **命令详细**: [COMMANDS.md](COMMANDS.md)
- **核心组件**: [CORE-COMPONENTS.md](CORE-COMPONENTS.md)
- **重构路线**: [roadmap.md](roadmap.md)
- **术语表**: [术语表.md](术语表.md)

### 引用格式
```markdown
详见 [术语表](术语表.md#epic-相关) 中的 Epic 相关定义。
参考 [架构设计](ARCHITECTURE.md#核心设计原则) 了解设计原则。
```
...
**📝 说明**: 本术语表是 GPF 项目的标准参考，所有文档编写和代码实现都应遵循此术语规范。如需添加新术语，请更新本文档并通知所有项目成员。